...
* Unavailable Internet (i.e Net connection is neither switched ON nor availaible.)
	- The app will have the permission to read all incoming texts. The moment a SMS, meant for this app is received, they app will move to Active Status.
```

#### Active Stage

```
1. Override Audio Setting and play an emergency sound on full volume. (can be customised to also speak the type of disaster.)
